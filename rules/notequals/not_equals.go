...
func init() {
	core.RegisterRuleWithParam("ne", notEquals)
}
func notEquals(value interface{}, param string, label string, kind reflect.Kind) *core.FieldError {
